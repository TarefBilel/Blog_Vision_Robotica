...
The following figures show the behavior of the localization system during different stages of navigation.

The green robot represents the Ground Truth pose, while the red robot represents the estimated pose generated by the visual localization system.

The objective is to keep the estimated robot as close as possible to the Ground Truth trajectory.

---

## ✅ Result 1 — Initial Detection

At the beginning, the robot successfully detects the AprilTag and initializes the localization system.

- AprilTag detection works correctly
- Initial pose estimation is stable
- Red estimated pose is close to Ground Truth

![Result 1](img1_P3.png)

---

## ✅ Result 2 — Visual Pose Update

The robot approaches the marker and updates its pose using visual information.

- PnP estimation works correctly
- Visual correction reduces odometry drift
- Estimated pose follows robot movement

![Result 2](img2_P3.png)

---

## ✅ Result 3 — Continuous Localization

The localization system keeps updating while the robot moves through the environment.

- Red trajectory follows Ground Truth
- Multi-frame tracking remains stable
- Visual updates are fused with odometry

![Result 3](img3_P3.png)

---

## ✅ Result 4 — Long Trajectory Tracking

The robot continues navigating while maintaining localization consistency.

- Estimated pose remains stable
- The robot keeps tracking the marker correctly
- Odometry prediction prevents freezing when tags are temporarily lost

![Result 4](img4_P3.png)

---

## ✅ Result 5 — Obstacle and Border Navigation

The robot navigates near obstacles and environment borders while preserving localization.

- Pose estimation remains functional near walls
- Visual correction stabilizes the trajectory
- The system handles partial tag visibility

![Result 5](img5_P3.png)

---

## ✅ Result 6 — Final Localization State

Final navigation result after multiple visual updates and trajectory corrections.

- Red estimated pose remains close to Ground Truth
- The localization pipeline stays robust during long motion
- Odometry drift is continuously corrected using AprilTags
...
The system achieves stable real-time localization and keeps the estimated robot trajectory close to the Ground Truth trajectory throughout navigation.
